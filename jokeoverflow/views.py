...
def index(request):
    ...
    context_dict = {'Joke Categories': category_list, 'Top Rated Videos': rated_videos, 'Top Rated Jokes': rated_jokes }
    visitor_cookie_handler(request)
    response = render(request, 'jokeoverflow/index.html', context=context_dict)
    return response
...
def about(request):
    ...
    return render(request, "jokeoverflow/about.html", context=context_dict)
